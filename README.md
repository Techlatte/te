...
## Features
- **Explore Rooms**: `move [direction]` (e.g., `north`, `south`).
- **Talk to Characters**: `talk` to interact.
- **Fight Enemies**: `fight` to engage in combat.
- **Collect Items**: `pick up [item]` to collect items.
- **Solve Puzzles**: Solve puzzles to progress.
